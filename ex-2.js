...
// Start coding here
function totalAmountPaid(customerName, orders) {
  let totalAmount = 0;
...
let totalPaid = totalAmountPaid(customerName, orders);
console.log(`Total paid amount of ${customerName}: ${totalPaid} Baht`)